      ...
      <main>
        ...
        <section id="process" className="py-20 px-4 bg-dark-bg">
           <div className="container mx-auto text-center">
              <h2 className="text-4xl font-bold mb-4">{t('nav-process')}</h2>
              <p className="text-gray-400">Step by step to your success</p>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-12">
                 {['Briefing', 'Prototype', 'Design', 'Launch'].map((step, i) => (
      ...
      <footer className="py-12 px-4 border-t border-white/5">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-sm text-gray-500">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-shimmer-effect text-lg">the Future Pages Vibe</span>
