...
export const Services: React.FC<ServicesProps> = ({ t }) => {
  const items = [
    ...
    { icon: <Search className="text-neon-violet" />, title: 'SEO Optimization', desc: 'Higher positions in search results', delay: 0.1 },
    { icon: <Smartphone className="text-neon-pink" />, title: 'Responsive', desc: 'Looks great on every device', delay: 0.2 },
    { icon: <BarChart3 className="text-neon-orange" />, title: 'Marketing', desc: 'CRM and Analytics integration', delay: 0.3 },
  ];
